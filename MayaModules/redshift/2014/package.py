...
def commands():
    ...
    redshift_module_path = os.path.join(module_path, "redshift/2014".replace('/', os.sep))
    ...
    env.REDSHIFT_SCRIPT_PATH.set(os.path.join(getenv("REDSHIFT_COREDATAPATH"), "Plugins/Maya/Common/scripts"))
    env.REDSHIFT_XBMLANGPATH.set(os.path.join(getenv("REDSHIFT_COREDATAPATH"), "Plugins/Maya/Common/icons"))
    env.REDSHIFT_RENDER_DESC_PATH.set(os.path.join(getenv("REDSHIFT_COREDATAPATH"), "Plugins/Maya/Common/rendererDesc"))
    env.REDSHIFT_CUSTOM_TEMPLATE_PATH.set(os.path.join(getenv("REDSHIFT_COREDATAPATH"), "Plugins/Maya/Common/scripts/NETemplates"))

    env.REDSHIFT_PLUG_IN_PATH.set(
        os.path.join(redshift_module_path, 'Plugins/Maya/2014/nt-x86-64'.replace('/', os.sep)))
